...
export const ShareMessage = z.discriminatedUnion("type", [
  RequestInfoMessage,
...
export type ShareMessage = z.infer<typeof ShareMessage>;

export function decodeShareMessage(data: unknown): ShareMessage | null {
  try {
    return ShareMessage.parse(data);
  } catch {
    return null;
  }
}
